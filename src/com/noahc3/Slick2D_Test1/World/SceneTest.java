...
public class SceneTest extends Scene {
    ...
    public SceneTest(Identifier identifier, String displayName) {
        ...
        try {
            ...
            entities.add(new EntityItem(new ScenePoint(new Point(500, 139), this.getIdentifier()), new BasicItem("test", new Image("/assets/textures/debug.png"), new Identifier("sound.effect.pickup"))));
            entities.add(new EntitySlime("slime", new ScenePoint(new Point(858, 206), this.getIdentifier())));
